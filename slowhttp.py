...
class SSHManager:
    ...
    def deploy_agent(self, ip, agent_type="standard"):
        ...
        try:
            ...
            import base64
            agent_script_b64 = base64.b64encode(agent_script.encode()).decode()
            write_cmd = f"echo '{agent_script_b64}' | base64 -d > ~/slowhttp_agent/agent.py"
...
class SlowHTTPTUI:
    ...
    def __init__(self):
        ...
        self.running = True
        self.version = VERSION  # Store VERSION as instance variable to avoid scope issues
    ...
    def run(self):
        ...
        while self.running:
            ...
            self.terminal.print_banner(self.version)
